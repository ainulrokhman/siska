...
<div class="dosen-form">
    ...
    <?php
        echo $form->field($model, 'kecamatan_id',[
                ...
                'select2Options' => ['pluginOptions' => ['allowClear' => true]],
                'pluginOptions'=>[
                    'depends'=>['dosen-kabupaten_id'],
                    'loadingText' => 'Loading...',
                    // 'initialize' => true,
                    'initDepends' => ['dosen-provinsi_id'],
    ...
    <?= $form->field($model, 'status_id')->widget(Select2::className(),[
        'data' => LookUp::getDropDownParameter('status_dosen'),
