...
class DosenSearch extends Dosen
{
    ...
    {
        return [
            [['id', 'jenis_kelamin_id', 'pendidikan_id', 'status_id', 'user_id'], 'integer'],
            [['nidn', 'nama_lengkap', 'alamat', 'provinsi_id', 'kabupaten_id', 'kecamatan_id', 'kelurahan_id', 'no_hp', 'tmp_lahir', 'tgl_lahir'], 'safe'],
        ];
    }
